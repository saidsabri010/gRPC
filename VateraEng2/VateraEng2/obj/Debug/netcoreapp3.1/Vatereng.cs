...
namespace VateraEng2 {
    ...
    static VaterengReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ASgFEgsKA3VpZBgEIAEoCSIkCgVEYXRhMhIbCgVpdG1lcxgBIAMoCzIMLnZh",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::VateraEng2.Data2), global::VateraEng2.Data2.Parser, new[]{ "Itmes" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class Data2 : pb::IMessage<Data2> {
    ...
    /// <summary>Field number for the "itmes" field.</summary>
    public const int ItmesFieldNumber = 1;
    private static readonly pb::FieldCodec<global::VateraEng2.Data> _repeated_itmes_codec
        = pb::FieldCodec.ForMessage(10, global::VateraEng2.Data.Parser);
    private readonly pbc::RepeatedField<global::VateraEng2.Data> itmes_ = new pbc::RepeatedField<global::VateraEng2.Data>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::VateraEng2.Data> Itmes {
      get { return itmes_; }
    }
    ...
    public bool Equals(Data2 other) {
      ...
      if(!itmes_.Equals(other.itmes_)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      itmes_.WriteTo(output, _repeated_itmes_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    }
    ...
    public int CalculateSize() {
      int size = 0;
      size += itmes_.CalculateSize(_repeated_itmes_codec);
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
      return size;
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            itmes_.AddEntriesFrom(input, _repeated_itmes_codec);
            break;
          }
        }
      }
